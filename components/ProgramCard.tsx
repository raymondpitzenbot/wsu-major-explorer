...
import { Plus, ArrowRight, BookOpen, MapPin } from 'lucide-react';
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="mt-auto flex justify-between items-center">
                        ...
                        <button
                            ...
                            className={`w-9 h-9 rounded-full flex items-center justify-center transition-all duration-300 ${isAddedToCompare ? 'bg-primary-600 text-white' : 'bg-gray-700 text-gray-300 opacity-0 group-hover:opacity-100 hover:bg-primary-600 hover:text-white'}`}
